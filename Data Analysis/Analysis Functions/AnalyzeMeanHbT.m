function [AnalysisResults_CBVHbT] = AnalyzeMeanHbT(animalID,group,rootFolder,delim,AnalysisResults_CBVHbT)
...
% save results
AnalysisResults_CBVHbT.(animalID).MeanCBV.Rest.CBV_HbT.MeanAdjLH = LH_restCBVMean;
AnalysisResults_CBVHbT.(animalID).MeanCBV.Rest.CBV_HbT.MeanAdjRH = RH_restCBVMean;
AnalysisResults_CBVHbT.(animalID).MeanCBV.Rest.CBV_HbT.IndAdjLH = LH_ProcRestData;
AnalysisResults_CBVHbT.(animalID).MeanCBV.Rest.CBV_HbT.IndAdjRH = RH_ProcRestData;
AnalysisResults_CBVHbT.(animalID).MeanCBV.Rest.CBV_HbT.FileIDs = finalRestFileIDs;
...
% save results
AnalysisResults_CBVHbT.(animalID).MeanCBV.Whisk.CBV_HbT.MeanAdjLH = cell2mat(LH_whiskCBVMean);
AnalysisResults_CBVHbT.(animalID).MeanCBV.Whisk.CBV_HbT.MeanAdjRH = cell2mat(RH_whiskCBVMean);
AnalysisResults_CBVHbT.(animalID).MeanCBV.Whisk.CBV_HbT.IndAdjLH = LH_whiskCBV;
AnalysisResults_CBVHbT.(animalID).MeanCBV.Whisk.CBV_HbT.IndAdjRH = RH_whiskCBV;
AnalysisResults_CBVHbT.(animalID).MeanCBV.Whisk.CBV_HbT.FileIDs = finalWhiskFileIDs;
...
% save results
AnalysisResults_CBVHbT.(animalID).MeanCBV.Stim.CBV_HbT.MeanAdjLH = cell2mat(LH_stimCBVMean);
AnalysisResults_CBVHbT.(animalID).MeanCBV.Stim.CBV_HbT.MeanAdjRH = cell2mat(RH_stimCBVMean);
AnalysisResults_CBVHbT.(animalID).MeanCBV.Stim.CBV_HbT.IndAdjLH = LH_stimCBV;
AnalysisResults_CBVHbT.(animalID).MeanCBV.Stim.CBV_HbT.IndAdjRH = RH_stimCBV;
AnalysisResults_CBVHbT.(animalID).MeanCBV.Stim.CBV_HbT.LH_FileIDs = LH_finalStimFileIDs;
AnalysisResults_CBVHbT.(animalID).MeanCBV.Stim.CBV_HbT.RH_FileIDs = RH_finalStimFileIDs;
...
% save results
AnalysisResults_CBVHbT.(animalID).MeanCBV.NREM.CBV_HbT.MeanAdjLH = LH_nremCBVMean;
AnalysisResults_CBVHbT.(animalID).MeanCBV.NREM.CBV_HbT.MeanAdjRH = RH_nremCBVMean;
AnalysisResults_CBVHbT.(animalID).MeanCBV.NREM.CBV_HbT.IndAdjLH = LH_nremData;
AnalysisResults_CBVHbT.(animalID).MeanCBV.NREM.CBV_HbT.IndAdjRH = RH_nremData;
AnalysisResults_CBVHbT.(animalID).MeanCBV.NREM.CBV_HbT.FileIDs = nremFileIDs;
...
% save results
AnalysisResults_CBVHbT.(animalID).MeanCBV.REM.CBV_HbT.MeanAdjLH = LH_remCBVMean;
AnalysisResults_CBVHbT.(animalID).MeanCBV.REM.CBV_HbT.MeanAdjRH = RH_remCBVMean;
AnalysisResults_CBVHbT.(animalID).MeanCBV.REM.CBV_HbT.IndAdjLH = LH_remData;
AnalysisResults_CBVHbT.(animalID).MeanCBV.REM.CBV_HbT.IndAdjRH = RH_remData;
AnalysisResults_CBVHbT.(animalID).MeanCBV.REM.CBV_HbT.FileIDs = remFileIDs;
...
try
    ...
    % save results
    AnalysisResults_CBVHbT.(animalID).MeanCBV.Iso.CBV_HbT.adjLH = mean(filtIsoLH_HbT);
    AnalysisResults_CBVHbT.(animalID).MeanCBV.Iso.CBV_HbT.adjRH = mean(filtIsoRH_HbT);
    AnalysisResults_CBVHbT.(animalID).MeanCBV.Iso.CBV_HbT.FileIDs = procDataFileID;
catch
    % save results
    AnalysisResults_CBVHbT.(animalID).MeanCBV.Iso.CBV_HbT.adjLH = [];
    AnalysisResults_CBVHbT.(animalID).MeanCBV.Iso.CBV_HbT.adjRH = [];
    AnalysisResults_CBVHbT.(animalID).MeanCBV.Iso.CBV_HbT.FileIDs = [];
end
% save data
cd(rootFolder)
