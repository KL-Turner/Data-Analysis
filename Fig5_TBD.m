function [AnalysisResults] = Fig5_TBD(rootFolder,saveFigs,delim,AnalysisResults)
...
if saveFigs == true
    ...
    savefig(summaryFigure,[dirpath 'Fig5_TBD']);
    set(summaryFigure,'PaperPositionMode','auto');
    print('-painters','-dpdf','-fillpage',[dirpath 'Fig5_TBD'])
end
