...
%________________________________________________________________________________________________________________________
%
% Purpose: Generate figure panel 1 for Turner_Gheres_Proctor_Drew_eLife2020
%________________________________________________________________________________________________________________________
clear; clc; close all;
...
figure;
subplot(2,1,1)
plot((1:length(rawEMG))/analogFs,rawEMG,'k','LineWidth',0.5);
title('Raw EMG')
xlabel('Time (s)')
...
xlim([0,600])
subplot(2,1,2)
plot((1:length(rawFiltEMG))/analogFs,rawFiltEMG,'k','LineWidth',0.5);
...
[LH_Sr,LH_tr,LH_rf,LH_HR] = FindHeartRate_Neurophotonics2021(ProcData.data.CBV.LH,ProcData.notes.CBVCamSamplingRate);
[RH_Sr,RH_tr,RH_rf,RH_HR] = FindHeartRate_Neurophotonics2021(ProcData.data.CBV.RH,ProcData.notes.CBVCamSamplingRate);
...
function [Sr,tr,fr,HR] = FindHeartRate_Neurophotonics2021(r,Fr)
