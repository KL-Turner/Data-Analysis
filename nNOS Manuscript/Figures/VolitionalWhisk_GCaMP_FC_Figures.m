function [] = VolitionalWhisk_GCaMP_FC_Figures(rootFolder,saveFigs,delim)
%----------------------------------------------------------------------------------------------------------
    ...
    for bb = 1:length(dataTypes)
        ...
        for cc = 1:length(whiskTypes)
            ...
            if saveFigs == true
                ...
                savefig(summaryFigure,[dirpath 'VolitionalWhisk_GCaMP_FC_' hemisphere '_' dataType '_' whiskType]);
            end
        end
    end
end