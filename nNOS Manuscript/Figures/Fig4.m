...
ax1 = subplot(1,2,1);
p1 = plot(T1,data.NREMtoREM.meanHbT,'-','color',colors('dark candy apple red'),'LineWidth',2);
ylabel('\Delta[HbT] (\muM)')
ylim([40,80])
yyaxis right
p2 = plot(data.VesselTransitions.NREMtoREM.timeVector,data.VesselTransitions.NREMtoREM.mean,'color',colors('rich black'),'LineWidth',2);
...
ax2 = subplot(1,2,2);
plot(T1,data.REMtoAWAKE.meanHbT,'-','color',colors('dark candy apple red'),'LineWidth',2);
ylabel('\Delta[HbT] (\muM)')
ylim([0,80])
yyaxis right
plot(data.VesselTransitions.REMtoAwake.timeVector,data.VesselTransitions.REMtoAwake.mean,'color',colors('rich black'),'LineWidth',2)
...
ax1 = subplot(6,2,1);
% HbT and EMG
p1 = plot(T1,data.AWAKEtoNREM.meanHbT,'-','color',colors('dark candy apple red'),'LineWidth',2);
hold on
plot(T1,data.AWAKEtoNREM.meanHbT + data.AWAKEtoNREM.stdHbT,'-','color',colors('dark candy apple red'),'LineWidth',0.5);
plot(T1,data.AWAKEtoNREM.meanHbT - data.AWAKEtoNREM.stdHbT,'-','color',colors('dark candy apple red'),'LineWidth',0.5);
ylabel('\Delta[HbT] (\muM)')
xlim([-30,30])
ylim([-5,50])
...
ax4 = subplot(6,2,2);
% HbT and EMG
plot(T1,data.NREMtoAWAKE.meanHbT,'-','color',colors('dark candy apple red'),'LineWidth',2);
hold on
plot(T1,data.NREMtoAWAKE.meanHbT + data.NREMtoAWAKE.stdHbT,'-','color',colors('dark candy apple red'),'LineWidth',0.5);
plot(T1,data.NREMtoAWAKE.meanHbT - data.NREMtoAWAKE.stdHbT,'-','color',colors('dark candy apple red'),'LineWidth',0.5);
ylabel('\Delta[HbT] (\muM)')
xlim([-30,30])
ylim([-5,50])
...
ax7 = subplot(6,2,7);
% HbT and EMG
plot(T1,data.NREMtoREM.meanHbT,'-','color',colors('dark candy apple red'),'LineWidth',2);
hold on
plot(T1,data.NREMtoREM.meanHbT + data.NREMtoREM.stdHbT,'-','color',colors('dark candy apple red'),'LineWidth',0.5);
plot(T1,data.NREMtoREM.meanHbT - data.NREMtoREM.stdHbT,'-','color',colors('dark candy apple red'),'LineWidth',0.5);
ylabel('\Delta[HbT] (\muM)')
xlim([-30,30])
ylim([35,90])
...
plot(T1,data.REMtoAWAKE.meanHbT,'-','color',colors('dark candy apple red'),'LineWidth',2);
hold on
plot(T1,data.REMtoAWAKE.meanHbT + data.REMtoAWAKE.stdHbT,'-','color',colors('dark candy apple red'),'LineWidth',0.5);
plot(T1,data.REMtoAWAKE.meanHbT - data.REMtoAWAKE.stdHbT,'-','color',colors('dark candy apple red'),'LineWidth',0.5);
ylabel('\Delta[HbT] (\muM)')
xlim([-30,30])
ylim([0,90])
