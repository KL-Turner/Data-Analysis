...
AnalyzePearsonCorrelation_Ephys_Handler(rootFolder,delim,true)
AnalyzePearsonCorrelation_GCaMP_Handler(rootFolder,delim,true)
...
AnalyzeHRF_Ephys_Handler(rootFolder,delim,true)
