function [figHandle] = GenerateTrialFigures_SI_IOS(procDataFileID,RestingBaselines)
...
if any(strcmp(imagingWavelengths,{'Red, Green, & Blue','Lime, Green, & Blue'})) == true
    ...
    % GCaMP
    ax4 = subplot(8,1,4);
    plot((1:length(filtBarrels_GCaMP7s))/ProcData.notes.CBVCamSamplingRate,filtBarrels_GCaMP7s,'color',colors('dark candy apple red'),'LineWidth',1);
    ...
    % Deoxy
    ax5 = subplot(8,1,5);
    plot((1:length(filtBarrels_Deoxy))/ProcData.notes.CBVCamSamplingRate,filtBarrels_Deoxy,'color',colors('dark candy apple red'),'LineWidth',1);
