function [RestingBaselines] = CalculateManualRestingBaselines_IOS_eLife2020(animalID,procDataFileIDs,RestData,RestingBaselines,imagingType)
...
if isfield(RestingBaselines,'manualSelection') == false && exist(manualBaselineFileID) == false
    ...
    for a = 1:size(procDataFileIDs,1)
        ...
        x = false;
        while x == false
            [singleTrialFig] = GenerateSingleFigures_IOS_eLife2020(procDataFileID,RestingBaselines,baselineType,saveFigs,imagingType);
