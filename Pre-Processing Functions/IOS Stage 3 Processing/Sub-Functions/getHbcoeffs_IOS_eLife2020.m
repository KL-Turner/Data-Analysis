function [weightedcoeffHbO,weightedcoeffHbR,weightedcoeffHbT] = getHbcoeffs_IOS_eLife2020(ledType,bandfilterType,cutfilterType)
%% 
...
%Inputs: 
%ledType:string, model of led used for illumination ex: 'M565L3'
%filterType:string,model of filter used in light path. ex:'FB570-10'
%Outputs:
%weightedcoeffHbO: weighted coeff using HbO extinction value
%weightedcoeffHbR: weighted coeff using HbR extrinction value
...
% \DelatHbT=(-1/\Chi(lambda)*\Epsilon(lambda)).*log(I(t)/I(to));
