function StageOneProcessing_2P_eLife2020(fileNames,trackWhiskers)
...
for a = 1:length(fileNames)
    ...
    [~,~,~,fileID] = GetFileInfo_2P_eLife2020(indFile);
    ...
    if isempty(fileExist)
        ...
        trialData = ReadInTDMSWhiskerTrials_2P_eLife2020([fileID '.tdms']);
        % force sensor data
        ...
        if trackWhiskers
            [whiskerAngle] = WhiskerTrackerParallel_2P_eLife2020(fileID);
