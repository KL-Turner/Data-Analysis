function [RestingBaselines] = CalculateManualRestingBaselines_FP(animalID,procDataFileIDs,RestData,RestingBaselines,imagingType)
...
if isfield(RestingBaselines,'manualSelection') == false && exist(manualBaselineFileID) == false
    ...
    for a = 1:size(procDataFileIDs,1)
        ...
        x = false;
        while x == false
            [singleTrialFig] = GenerateSingleFigures_FP(procDataFileID,RestingBaselines,baselineType,saveFigs,imagingType);
