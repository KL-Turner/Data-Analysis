function [] = CorrectBilateralPixelDrift_IOS_eLife2020(procDataFileIDs)
...
[animalIDs,fileDates,~] = GetFileInfo_IOS_eLife2020(procDataFileIDs);
...
for b = 1:length(firstsFileOfDay)
    ...
    [~,fileDate,~] = GetFileInfo_IOS_eLife2020(fileName);
