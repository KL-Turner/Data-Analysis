function [maxspot,xc_image,xshift]=linescan_xcov_2P(mv_mpP)
...
x_spread=round(max(1,.5/mv_mpP.Header.notes.Xfactor));%spatial gaussian with 0.5um std
t_spread=round(mv_mpP.Header.notes.Tfactor/10);%temporal gaussian with 10ms std
