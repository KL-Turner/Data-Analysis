function [] = TemplateMatchFiberData_FP(trialDataFileID,rawDataFileIDs)
...
for aa = 1:size(rawDataFileIDs,1)
    ...
    load(rawDataFileID)
    disp(['Correcting offset in file number ' num2str(aa) ' of ' num2str(size(trialDataFileID, 1)) '...']); disp(' ');
