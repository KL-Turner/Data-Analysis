...
%________________________________________________________________________________________________________________________
%
% Purpose: Generate supplemental videos for Turner_Kederasetti_Gheres_Proctor_Costanzo_Drew
%________________________________________________________________________________________________________________________
...
baseCBVframes = GetCBVFrameSubset_IOS(exampleCBVcamFileID_A,cbvImageHeight,cbvImageWidth,baseFrameIndex);
awakeCBVframes = GetCBVFrameSubset_IOS(exampleCBVcamFileID_A,cbvImageHeight,cbvImageWidth,awakeFrameIndex);
remCBVframes = GetCBVFrameSubset_IOS(exampleCBVcamFileID_A,cbvImageHeight,cbvImageWidth,remFrameIndex);
...
% Obtain subset of desired frames
nremCBVframes = GetCBVFrameSubset_IOS(exampleCBVcamFileID_B,cbvImageHeight,cbvImageWidth,nremFrameIndex);
...
try
    ...
    ylim([-20,61.5])
    yyaxis right
    p2 = plot((1:length(heartRate)),heartRate,'color',colors('deep carrot orange'),'LineWidth',0.5);
    ...
    ax12.YAxis(2).Color = colors('deep carrot orange');
...
exampleBaselineFileID = 'T123_RestingBaselines.mat';
load(exampleBaselineFileID,'-mat')
[~,fileDate,~] = GetFileInfo_IOS(exampleProcDataFileID_A);
