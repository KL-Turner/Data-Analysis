function [] = CreateTrainingDataSet_FP(procDataFileIDs,RestingBaselines,baselineType)
...
for a = 1:size(procDataFileIDs,1)
    ...
    if ~exist(trainingDataFileID,'file')
        ...
        hemoType = 'HbT';
        [figHandle,ax1,ax2,ax3,ax4,ax5,ax6] = GenerateSingleFigures_FP(procDataFileID,RestingBaselines,baselineType,saveFigs,imagingType,hemoType);
