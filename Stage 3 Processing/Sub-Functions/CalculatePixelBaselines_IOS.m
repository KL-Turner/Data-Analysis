function [RestingBaselines] = CalculatePixelBaselines_IOS(procDataFileIDs,RestingBaselines,baselineType)
...
for a = 1:length(restFileList)
    ...
    for b = 1:size(procDataFileIDs,1)
        ...
        [animalID,~,procDataFile] = GetFileInfo_IOS(procDataFileID);
