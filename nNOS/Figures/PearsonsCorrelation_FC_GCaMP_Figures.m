function [] = PearsonsCorrelation_FC_GCaMP_Figures(rootFolder,saveFigs,delim)
%----------------------------------------------------------------------------------------------------------
...
for qq = 1:length(dataTypes)
    ...
    sgtitle([dataType ' Pearsons Corr [FC GCaMP]'])
    ...
    % save figure(s)
    if saveFigs == true
        dirpath = [rootFolder delim 'Summary Figures' delim 'Pearsons Corr FC GCaMP' delim];
