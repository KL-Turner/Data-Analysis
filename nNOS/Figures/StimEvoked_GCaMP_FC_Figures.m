...
for aa = 1:length(hemispheres)
    ...
    for bb = 1:length(dataTypes)
        ...
        for cc = 1:length(comparisons)
            ...
            sgtitle([hemisphere ' ' dataType ' ' comparison ' whisker stimlation [GCaMP FC]'])
            subplot(1,3,cc);
            ...
            if saveFigs == true
                ...
                savefig(summaryFigure,[dirpath 'StimEvoked_GCaMP_FC_' hemisphere '_' dataType '_' comparison]);
            end
        end
    end
end
...
if saveFigs == true
    % statistical diary
    diaryFile = [dirpath 'StimEvoked_GCaMP_FC_Statistics.txt'];
