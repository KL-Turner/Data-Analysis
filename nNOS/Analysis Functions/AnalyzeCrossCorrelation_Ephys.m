...
for aa = 1:length(dataTypes)
    ...
    % save results
    Results_CrossCorr_Ephys.(group).(animalID).(dataType).Rest.LFP_lags = restLFP_lags;
    Results_CrossCorr_Ephys.(group).(animalID).(dataType).Rest.MUA_lags = restMUA_lags;
    Results_CrossCorr_Ephys.(group).(animalID).(dataType).Rest.F = rest_F;
    Results_CrossCorr_Ephys.(group).(animalID).(dataType).Rest.HbTvLFPxcVals = restMeanHbTvLFPxcVals;
    Results_CrossCorr_Ephys.(group).(animalID).(dataType).Rest.HbTvMUAxcVals = restMeanHbTvMUAxcVals;
    Results_CrossCorr_Ephys.(group).(animalID).(dataType).Rest.HbTvMUAxcVals_std = restStdHbTvMUAxcVals;
    ...
    % save results
    Results_CrossCorr_Ephys.(group).(animalID).(dataType).NREM.LFP_lags = NREM_LFP_lags;
    Results_CrossCorr_Ephys.(group).(animalID).(dataType).NREM.MUA_lags = NREM_MUA_lags;
    Results_CrossCorr_Ephys.(group).(animalID).(dataType).NREM.F = NREM_F;
    Results_CrossCorr_Ephys.(group).(animalID).(dataType).NREM.HbTvLFPxcVals = NREM_meanHbTvLFPxcVals;
    Results_CrossCorr_Ephys.(group).(animalID).(dataType).NREM.HbTvMUAxcVals = NREM_meanHbTvMUAxcVals;
    Results_CrossCorr_Ephys.(group).(animalID).(dataType).NREM.HbTvMUAxcVals_std = NREM_stdHbTvMUAxcVals;
    ...
    % save results
    Results_CrossCorr_Ephys.(group).(animalID).(dataType).REM.LFP_lags = REM_LFP_lags;
    Results_CrossCorr_Ephys.(group).(animalID).(dataType).REM.MUA_lags = REM_MUA_lags;
    Results_CrossCorr_Ephys.(group).(animalID).(dataType).REM.F = REM_F;
    Results_CrossCorr_Ephys.(group).(animalID).(dataType).REM.HbTvLFPxcVals = REM_meanHbTvLFPxcVals;
    Results_CrossCorr_Ephys.(group).(animalID).(dataType).REM.HbTvMUAxcVals = REM_meanHbTvMUAxcVals;
    Results_CrossCorr_Ephys.(group).(animalID).(dataType).REM.HbTvMUAxcVals_std = REM_stdHbTvMUAxcVals;
end
% save data
