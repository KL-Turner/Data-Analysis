...
whisking_Yvals = 80*max(HbO)*ones(size(binWhiskers));
LPad_Yvals = 80*ones(size(LPadSol));
RPad_Yvals = 80*ones(size(RPadSol));
Aud_Yvals = 80*ones(size(AudSol));
