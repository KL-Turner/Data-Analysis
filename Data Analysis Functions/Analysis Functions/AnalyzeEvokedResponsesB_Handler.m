function [] = AnalyzeEvokedResponsesB_Handler(rootFolder,delim,runFromStart)
...
for aa = 1:length(expGroups)  
    ...
    for bb = 1:length(animalIDs)
        if isfield(Results_Evoked,(animalIDs{1,bb})) == false
            [Results_Evoked] = AnalyzeEvokedResponses(animalIDs{1,bb},[expGroups{1,aa} delim 'IOS Set B'],rootFolder,delim,Results_Evoked);
        end
