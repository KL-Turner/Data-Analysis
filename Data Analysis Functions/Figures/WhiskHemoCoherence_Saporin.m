function [AnalysisResults] = WhiskHemoCoherence_Saporin(rootFolder,saveFigs,delim,AnalysisResults)
...
subplot(3,2,1);
s1 = semilogx(data.C57BL6J.Awake.LH.meanf,data.C57BL6J.Awake.LH.meanC.^2,'color',colors('sapphire'),'LineWidth',2);
hold on
...
%% coherence^2 between bilateral HbT during Awake
subplot(3,2,2);
semilogx(data.C57BL6J.Awake.RH.meanf,data.C57BL6J.Awake.RH.meanC.^2,'color',colors('sapphire'),'LineWidth',2);
hold on
...
subplot(3,2,3);
semilogx(data.C57BL6J.Sleep.LH.meanf,data.C57BL6J.Sleep.LH.meanC.^2,'color',colors('sapphire'),'LineWidth',2);
hold on
...
%% coherence^2 between bilateral HbT during Sleep
subplot(3,2,4);
semilogx(data.C57BL6J.Sleep.RH.meanf,data.C57BL6J.Sleep.RH.meanC.^2,'color',colors('sapphire'),'LineWidth',2);
hold on
...
subplot(3,2,5);
semilogx(data.C57BL6J.All.LH.meanf,data.C57BL6J.All.LH.meanC.^2,'color',colors('sapphire'),'LineWidth',2);
hold on
...
%% coherence^2 between bilateral HbT during All data
subplot(3,2,6);
semilogx(data.C57BL6J.All.RH.meanf,data.C57BL6J.All.RH.meanC.^2,'color',colors('sapphire'),'LineWidth',2);
hold on
