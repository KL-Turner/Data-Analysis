function [AnalysisResults] = Fig3_S2_eLife2020(rootFolder,saveFigs,delim,AnalysisResults)
...
%________________________________________________________________________________________________________________________
%
% Purpose: Generate figure panel 3_S2 for Turner_Gheres_Proctor_Drew_eLife2020
%________________________________________________________________________________________________________________________
...
%% Fig. 3_S2
summaryFigure = figure('Name','Fig3_S2 (a-e)'); %#ok<*NASGU>
sgtitle('Figure 3_S2 - Turner et al. 2020')
...
if strcmp(saveFigs,'y') == true
    ...
    savefig(summaryFigure,[dirpath 'Fig3_S2']);
    ...
    print('-painters','-dpdf','-fillpage',[dirpath 'Fig3_S2'])
    close(summaryFigure)
    %% subplot figures
    ...
    axis off
    xlim([0,600])
    print('-painters','-dtiffn',[dirpath 'Fig3_S2_SpecImages'])
    close(summaryFigure_imgs)
    %% Fig. 3_S2
    figure('Name','Fig3_S2 (a-f)');
    sgtitle('Figure 3_S2 - Turner et al. 2020')
    %% EMG and force sensor
    ax1 = subplot(6,1,1);
    p1 = plot((1:length(filtEMG))/dsFs,filtEMG,'color',colors_eLife2020('rich black'),'LineWidth',0.5);
