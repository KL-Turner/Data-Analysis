...
% save results
Results_BehavDiameter.(animalID).Stim.LH_meanPupilArea = cell2mat(LH_stimMean);
Results_BehavDiameter.(animalID).Stim.RH_meanPupilArea = cell2mat(RH_stimMean);
Results_BehavDiameter.(animalID).Stim.LH_indPupilArea = LH_stim;
Results_BehavDiameter.(animalID).Stim.RH_indPupilArea = RH_stim;
Results_BehavDiameter.(animalID).Stim.LH_fileIDs = LH_finalStimFileIDs;
Results_BehavDiameter.(animalID).Stim.RH_fileIDs = RH_finalStimFileIDs;
