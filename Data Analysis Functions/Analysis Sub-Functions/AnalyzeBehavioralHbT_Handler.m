...
for aa = 1:length(expGroups)  
    ...
    for bb = 1:length(animalIDs)
        if isfield(Results_BehavHbT,(animalIDs{1,bb})) == false
            [Results_BehavHbT] = AnalyzeBehavioralHbT(animalIDs{1,bb},[expGroups{1,aa} delim 'IOS Set A'],rootFolder,delim,Results_BehavHbT);
        end
