...
for aa = 1:length(expGroups)  
    ...
    multiWaitbar('Analyzing stimulus and whisking evoked responses',0,'Color','P'); pause(0.25);
    for bb = 1:length(animalIDs)
        ...
        multiWaitbar('Analyzing stimulus and whisking evoked responses','Value',cc/waitBarLength);
        cc = cc + 1;
    end
end
